...
export async function prepararMezcla(m) {
  ...
  await ffmpeg([
    ...
    "-filter_complex",
    `[1:a]volume=${vol},afade=t=in:st=0:d=1[m];[0:a]apad=pad_dur=1.5[v];[v][m]amix=inputs=2:duration=first:dropout_transition=2,afade=t=out:st=${m.fadeOutAt || 0}:d=0[out]`,
